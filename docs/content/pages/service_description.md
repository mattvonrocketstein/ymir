...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>http://{{host}}
      <td>
        check address answers http requests, yields status code
      </td>
    </tr>
    <tr>
      <td>http_200</td>
      <td>http_200://{{host}}</td>
      <td>
        checks address answers http requests, assert response is 200
      </td>
    </tr>
    <tr>
      <td>http_301</td>
      <td>http_301://{{host}}</td>
      <td>
        checks address answers http requests, assert response is 301 (redirect)
      </td>
    </tr>
    <tr>
      <td>http_401</td>
      <td>http_401://{{host}}</td>
      <td>
        checks address answers http requests, assert response is 401 (redirect)
      </td>
    </tr>
    <tr>
      <td>http_403</td>
      <td>http_403://{{host}}</td>
      <td>
        checks address answers http requests, assert response is 403 (redirect)
      </td>
    </tr>
    <tr>
      <td>json</td>
      <td>json://{{host}}</td>
      <td>
        checks address answers http requests, assert response is json
      </td>
    </tr>
    <tr>
      <td>json_200</td>
      <td>json_200://{{host}}/url</td>
      <td>
        checks address answers http requests, assert response is json
      </td>
    </tr>
    <tr>
      <td>port_open</td>
      <td>port_open://{{port_number}}</td>
      <td>
        checks port is open
      </td>
    </tr>
    <tr>
      <td>socket-listening</td>
      <td>
      socket-listening://unix:///tmp/daemon.sock
      <br/>
      socket-listening://tcp://0.0.0.0:80
      <br/>
      </td>
      <td>
    ...
    <tr>
      <td>file-contains</td>
      <td>file-exists://filename,string</td>
      <td>
        checks that file exists and contains $string
      </td>
    </tr>
    <tr>
      <td>testinfra</td>
      <td>testinfra://some_testinfra_assertion</td>
      <td>
        executes a generic testinfra assertion
      </td>
    </tr>
</table>
